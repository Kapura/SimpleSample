// From https://forum.unity3d.com/threads/drawing-lines-in-the-editor.71979/#post-1334927
// Modified by Max Golden
...
namespace lines.Editor
{
    public static class Drawing
    {
        ...
        public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width = 1f, bool antiAlias = true)
        {
        ...
        public static void DrawBezierLine(Vector2 start, Vector2 startTangent, Vector2 end, Vector2 endTangent, Color color, int segments, float width = 1f, bool antiAlias = false)
        {
